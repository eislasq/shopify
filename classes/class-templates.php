...
class Templates
{
	...
	*/
    public function wps_products_loop_start($query)
    {
        ...
        return $this->Template_Loader
            ...
            ->get_template_part('components/products/loop/start');
    }
	...
	*/
    public function wps_products_loop_end($query)
    {
        ...
        return $this->Template_Loader
            ->set_template_data($data)
            ->get_template_part('components/products/loop/end');
    }
	...
	*/
    public function wps_products_item_start($product, $args, $customArgs)
    {
        ...
        if (
            isset($args->wps_related_products_items_per_row) &&
            $args->wps_related_products_items_per_row !== false
        ) {
        ...
        if (
            isset($customArgs['items-per-row']) &&
            $customArgs['items-per-row'] !== false
        ) {
        ...
        return $this->Template_Loader
            ->set_template_data($data)
            ->get_template_part('components/products/loop/item', 'start');
    }
	...
	*/
    public function wps_products_item_end($product)
    {
        ...
        return $this->Template_Loader
            ->set_template_data($data)
            ->get_template_part('components/products/loop/item', 'end');
    }
	...
	*/
    public function wps_products_item($product, $args, $settings)
    {
        ...
        return $this->Template_Loader
            ->set_template_data($data)
            ->get_template_part('components/products/loop/item');
    }
	...
	*/
    public function wps_products_item_link_start($product, $settings)
    {
        ...
        return $this->Template_Loader
            ->set_template_data($data)
            ->get_template_part('components/products/loop/item-link', 'start');
    }
	...
	*/
    public function wps_products_item_link_end($product)
    {
        ...
        return $this->Template_Loader
            ->set_template_data($data)
            ->get_template_part('components/products/loop/item-link', 'end');
    }
    ...
    public function wps_products_img($product)
    {
        ...
        if (!Images::has_placeholder($image->src)) {
            ...
            if (is_singular(WP_SHOPIFY_PRODUCTS_POST_TYPE_SLUG)) {
                $custom_sizing = apply_filters(
                    'wps_related_products_images_sizing',
                    $this->DB_Settings_General->get_related_products_images_sizing_toggle()
                );

                if ($custom_sizing) {
                    $data[
                        'custom_image_src'
                    ] = $this->get_related_products_custom_sized_image_url(
                        $image
                    );
                }
            } else {
                $custom_sizing = apply_filters(
                    'wps_products_images_sizing',
                    $this->DB_Settings_General->get_products_images_sizing_toggle()
                );

                if ($custom_sizing) {
                    $data[
                        'custom_image_src'
                    ] = $this->get_products_custom_sized_image_url($image);
                }
            }
        } else {
            $custom_sizing = false;
        ...
        return $this->Template_Loader
            ->set_template_data($data)
            ->get_template_part('components/products/loop/item', 'img');
    }
	...
	*/
    public function wps_products_description($product)
    {
        ...
        return $this->Template_Loader
            ->set_template_data($data)
            ->get_template_part('components/products/loop/item', 'description');
    }
	...
	*/
    public function wps_products_add_to_cart($product)
    {
        ...
        return $this->Template_Loader
            ->set_template_data($data)
            ->get_template_part('components/products/loop/item-add-to', 'cart');
    }

    public function price_multi_from_default()
    {
        return '<small class="wps-product-from-price">' .
            __('From: ', 'wpshopify') .
            '</small>';
    }
	...
	*/
    public function get_multi_price_markup($first_price, $last_price)
    {
        return apply_filters(
            'wps_products_price_multi_from',
            $this->price_multi_from_default()
        ) .
            apply_filters(
                'wps_products_price_multi_first',
                $this->add_price_wrapper($first_price, 'from')
            ) .
            apply_filters(
                'wps_products_price_multi_separator',
                $this->price_multi_separator_default()
            ) .
            apply_filters(
                'wps_products_price_multi_last',
                $this->add_price_wrapper($last_price, 'to')
            );
    }
    ...
    public function wps_products_price_wrapper_start()
    {
        return $this->Template_Loader
            ->set_template_data([])
            ->get_template_part(
                'components/products/add-to-cart/price-wrapper',
                'start'
            );
    }
	...
	*/
    public function get_range_pricing_params(
        $variants_in_stock,
        $product,
        $show_compare_at
    ) {
        if ($show_compare_at) {
            $variants_sorted = $this->DB_Variants->sort_variants_by_compare_at_price(
                $variants_in_stock
            );
            $variants_amount = $this->DB_Variants->get_variants_amount(
                $variants_sorted
            );

            $first_price = $this->DB_Variants->get_first_variant_compare_at_price(
                $variants_sorted
            );
            $last_price = $this->DB_Variants->get_last_variant_compare_at_price(
                $variants_sorted,
                Utils::get_last_index($variants_amount)
            );
        } else {
            $variants_sorted = $this->DB_Variants->sort_variants_by_price(
                $variants_in_stock
            );
            $first_price = $this->DB_Variants->get_first_variant_price(
                $variants_sorted
            );
            $variants_amount = $this->DB_Variants->get_variants_amount(
                $variants_in_stock
            );
            $last_price = $this->DB_Variants->get_last_variant_price(
                $variants_sorted,
                Utils::get_last_index($variants_amount)
            );
        }
        ...
        return [
            ...
            'show_local' => $this->DB_Settings_General->get_col_value(
                'pricing_local_currency_toggle',
                'bool'
            ),
            'variants_amount' => $variants_amount,
            'first_price' => $first_price,
            'first_price_formatted' => $this->Money->format_price(
                $first_price,
                $product->product_id
            ),
            'last_price' => $last_price,
            'last_price_formatted' => $this->Money->format_price(
                $last_price,
                $product->product_id
            ),
            'product' => $product,
	...
	*/
    public function get_single_pricing_params(
        $variants,
        $product,
        $show_compare_at
    ) {
        ...
        if ($show_compare_at) {
            ...
            $first_price = $this->DB_Variants->get_last_variant_compare_at_price(
                $variants,
                Utils::get_last_index($variants_amount)
            );
	...
	*/
    public function wps_products_header($query)
    {
        $heading = apply_filters(
            'wps_products_heading',
            $this->DB_Settings_General->get_products_heading()
        );
        ...
        if (!is_singular(WP_SHOPIFY_PRODUCTS_POST_TYPE_SLUG)) {
            return $this->Template_Loader
                ->set_template_data($data)
                ->get_template_part('components/products/loop/header');
        }
    }
	...
	*/
    public function wps_products_meta_start($product)
    {
        ...
        $data = [
            'product' => $product,
            'filtered_options' => Utils::normalize_option_values(
                $product->variants
            ),
        ];
        ...
        return $this->Template_Loader
            ->set_template_data($data)
            ->get_template_part(
                'components/products/add-to-cart/meta',
                'start'
            );
    }
	...
	*/
    public function wps_products_meta_end($product)
    {
        ...
        return $this->Template_Loader
            ->set_template_data($data)
            ->get_template_part('components/products/add-to-cart/meta', 'end');
    }
	...
	*/
    public function wps_products_quantity($product)
    {
        ...
        return $this->Template_Loader
            ->set_template_data($data)
            ->get_template_part('components/products/add-to-cart/quantity');
    }
	...
	*/
    public function wps_products_actions_group_start($product)
    {
        ...
        return $this->Template_Loader
            ->set_template_data($data)
            ->get_template_part('components/products/action-groups/start');
    }
	...
	*/
    public function wps_products_options($product)
    {
        ...
        $button_color = apply_filters(
            ...
            $this->DB_Settings_General->get_variant_color()
        );
        ...
        if (count($product->variants) > 1) {
            $data = [
                'product' => $product,
                'button_width' => Utils::get_options_button_width(
                    $product->options
                ),
                'button_color' =>
                    $button_color !== WP_SHOPIFY_DEFAULT_VARIANT_COLOR
                        ? $button_color
                        : '',
            ...
            return $this->Template_Loader
                ->set_template_data($data)
                ->get_template_part('components/products/add-to-cart/options');
        }
    }
	...
	*/
    public function wps_products_button_add_to_cart($product)
    {
        ...
        $button_color = apply_filters(
            ...
            $this->DB_Settings_General->get_add_to_cart_color()
        );
        ...
        $data = [
            ...
            'button_color' =>
                $button_color !== WP_SHOPIFY_DEFAULT_ADD_TO_CART_COLOR
                    ? $button_color
                    : WP_SHOPIFY_DEFAULT_ADD_TO_CART_COLOR,
            'button_text' =>
                $button_text !== WP_SHOPIFY_DEFAULT_ADD_TO_CART_TEXT
                    ? $button_text
                    : WP_SHOPIFY_DEFAULT_ADD_TO_CART_TEXT,
        ];
        ...
        return $this->Template_Loader
            ->set_template_data($data)
            ->get_template_part(
                'components/products/add-to-cart/button-add-to',
                'cart'
            );
    }
	...
	*/
    public function wps_products_actions_group_end($product)
    {
        ...
        return $this->Template_Loader
            ->set_template_data($data)
            ->get_template_part('components/products/action-groups/end');
    }
	...
	*/
    public function wps_products_notice_inline($product)
    {
        ...
        return $this->Template_Loader
            ->set_template_data($data)
            ->get_template_part('components/notices/add-to', 'cart');
    }
	...
	*/
    public function wps_products_no_results($args)
    {
        ...
        return $this->Template_Loader
            ->set_template_data($data)
            ->get_template_part('components/notices/no', 'results');
    }
	...
	*/
    public function wps_products_related_start()
    {
        ...
        return $this->Template_Loader
            ->set_template_data($data)
            ->get_template_part('components/products/related/start');
    }
	...
	*/
    public function wps_products_related_end()
    {
        ...
        return $this->Template_Loader
            ->set_template_data($data)
            ->get_template_part('components/products/related/end');
    }
	...
	*/
    ...
    {
        $heading = apply_filters(
            'wps_products_related_heading_text',
            $this->DB_Settings_General->get_related_products_heading()
        );
        ...
        return $this->Template_Loader
            ->set_template_data($data)
            ->get_template_part('components/products/related/heading');
    }
	...
	*/
    public function wps_related_products()
    {
        ...
        return $this->Template_Loader
            ->set_template_data($data)
            ->get_template_part('products', 'related');
    }
	...
	*/
    public function wps_collections_loop_start()
    {
        ...
        return $this->Template_Loader
            ->set_template_data($data)
            ->get_template_part('components/collections/loop/start');
    }
	...
	*/
    public function wps_collections_loop_end()
    {
        ...
        return $this->Template_Loader
            ->set_template_data($data)
            ->get_template_part('components/collections/loop/end');
    }
	...
	*/
    public function wps_collections_item_start($collection, $args, $customArgs)
    {
        ...
        return $this->Template_Loader
            ->set_template_data($data)
            ->get_template_part('components/collections/loop/item', 'start');
    }
	...
	*/
    public function wps_collections_item_end($collection)
    {
        ...
        return $this->Template_Loader
            ->set_template_data($data)
            ->get_template_part('components/collections/loop/item', 'end');
    }
	...
	*/
    public function wps_collections_item($collection)
    {
        ...
        return $this->Template_Loader
            ->set_template_data($data)
            ->get_template_part('components/collections/loop/item');
    }
	...
	*/
    public function wps_collections_item_before($collection)
    {
        ...
        return $this->Template_Loader
            ->set_template_data($data)
            ->get_template_part(
                'components/collections/loop/item-link',
                'start'
            );
    }
	...
	*/
    public function wps_collections_item_after($collection)
    {
        ...
        return $this->Template_Loader
            ->set_template_data($data)
            ->get_template_part('components/collections/loop/item-link', 'end');
    }
	...
	*/
    public function wps_collections_img($collection)
    {
        ...
        if (!Images::has_placeholder($image->src)) {
            $custom_sizing = apply_filters(
                'wps_collections_images_sizing',
                $this->DB_Settings_General->get_collections_images_sizing_toggle()
            );

            if ($custom_sizing) {
                $data[
                    'custom_image_src'
                ] = $this->get_collections_custom_sized_image_url($image);
            }
        } else {
            $custom_sizing = false;
        }
        ...
        return $this->Template_Loader
            ->set_template_data($data)
            ->get_template_part('components/collections/loop/item', 'img');
    }
	...
	*/
    public function wps_collections_title($collection)
    {
        ...
        return $this->Template_Loader
            ->set_template_data($data)
            ->get_template_part('components/collections/loop/item', 'title');
    }
	...
	*/
    ...
    {
        $heading = apply_filters(
            'wps_collections_heading',
            $this->DB_Settings_General->get_collections_heading()
        );
        ...
        return $this->Template_Loader
            ->set_template_data($data)
            ->get_template_part('components/collections/loop/header');
    }
	...
	*/
    public function wps_product_single_content($product)
    {
        if (
            ...
            return $this->Template_Loader
                ->set_template_data($data)
                ->get_template_part('components/products/single/content');
        } else {
            $data = [
                'type' => 'product',
            ];
            ...
            return $this->Template_Loader
                ->set_template_data($data)
                ->get_template_part('components/notices/no', 'description');
        }
    }
	...
	*/
    public function wps_product_single_header($product)
    {
        ...
        return $this->Template_Loader
            ->set_template_data($data)
            ->get_template_part('components/products/single/header');
    }
	...
	*/
    public function wps_product_single_heading($product)
    {
        ...
        return $this->Template_Loader
            ->set_template_data($data)
            ->get_template_part('components/products/single/heading');
    }
	...
	*/
    ...
    {
        $product->images = Utils::sort_product_images_by_position(
            $product->images
        );
        ...
        return $this->Template_Loader
            ->set_template_data($data)
            ->get_template_part('components/products/single/imgs');
    }
	...
	*/
    public function wps_product_single_img($data, $image)
    {
        ...
        $data->image_details = Images::get_image_details_from_image(
            $image,
            $data->product
        );
        ...
        if ($custom_sizing) {
            $data->custom_image_src = $this->get_products_custom_sized_image_url(
                $image
            );
        }
        ...
        return $this->Template_Loader
            ->set_template_data($data)
            ->get_template_part('components/products/single/img');
    }
	...
	*/
    public function wps_product_single_imgs_feat_placeholder($data)
    {
        ...
        return $this->Template_Loader
            ->set_template_data($data)
            ->get_template_part(
                'components/products/single/imgs-feat',
                'placeholder'
            );
    }
	...
	*/
    ...
    {
        $image_details = Images::get_image_details_from_image(
            $image,
            $data->product
        );
        ...
        return $this->Template_Loader
            ->set_template_data($data)
            ->get_template_part('components/products/single/imgs-feat');
    }
	...
	*/
    public function wps_product_single_info_start($product)
    {
        ...
        return $this->Template_Loader
            ->set_template_data($data)
            ->get_template_part('components/products/single/info', 'start');
    }
	...
	*/
    public function wps_product_single_info_end($product)
    {
        ...
        return $this->Template_Loader
            ->set_template_data($data)
            ->get_template_part('components/products/single/info', 'end');
    }
	...
	*/
    public function wps_product_single_gallery_start($product)
    {
        ...
        return $this->Template_Loader
            ->set_template_data($data)
            ->get_template_part('components/products/single/gallery', 'start');
    }
	...
	*/
    public function wps_product_single_gallery_end($product)
    {
        ...
        return $this->Template_Loader
            ->set_template_data($data)
            ->get_template_part('components/products/single/gallery', 'end');
    }
	...
	*/
    public function wps_product_single_start($product)
    {
        ...
        return $this->Template_Loader
            ->set_template_data($data)
            ->get_template_part('components/products/single/start');
    }
	...
	*/
    public function wps_product_single_end($product)
    {
        ...
        return $this->Template_Loader
            ->set_template_data($data)
            ->get_template_part('components/products/single/end');
    }
	...
	*/
    public function wps_products_notice_out_of_stock($product)
    {
        ...
        return $this->Template_Loader
            ->set_template_data($data)
            ->get_template_part('components/notices/out-of', 'stock');
    }
	...
	*/
    public function wps_collection_single_start($collection)
    {
        ...
        return $this->Template_Loader
            ->set_template_data($data)
            ->get_template_part('components/collections/single/start');
    }
	...
	*/
    public function wps_collection_single_header($collection)
    {
        ...
        return $this->Template_Loader
            ->set_template_data($data)
            ->get_template_part('components/collections/single/header');
    }
	...
	*/
    public function wps_collection_single_img($collection)
    {
        ...
        return $this->Template_Loader
            ->set_template_data($data)
            ->get_template_part('components/collections/single/img');
    }
	...
	*/
    public function wps_collection_single_content($collection)
    {
        if (
            ...
            property_exists($collection, 'body_html') &&
            !empty($collection->body_html)
        ) {
            $data = [
                'collection' => $collection,
            ];
            ...
            return $this->Template_Loader
                ->set_template_data($data)
                ->get_template_part('components/collections/single/content');
        } else {
            $data = [
                'type' => 'collection',
            ];
	...
	*/
    public function wps_collection_single_products($collection, $products)
    {
        ...
        return $this->Template_Loader
            ->set_template_data($data)
            ->get_template_part('components/collections/single/products');
    }
	...
	*/
    public function wps_collection_single_products_heading()
    {
        ...
        return $this->Template_Loader
            ->set_template_data($data)
            ->get_template_part(
                'components/collections/single/products',
                'heading'
            );
    }
	...
	*/
    public function wps_collection_single_end($collection)
    {
        ...
        return $this->Template_Loader
            ->set_template_data($data)
            ->get_template_part('components/collections/single/end');
    }
	...
	*/
    public function wps_collection_single_heading($collection)
    {
        ...
        return $this->Template_Loader
            ->set_template_data($data)
            ->get_template_part('components/collections/single/heading');
    }
	...
	*/
    public function wps_collection_single_product($product)
    {
        ...
        return $this->Template_Loader
            ->set_template_data($data)
            ->get_template_part('components/collections/single/product');
    }
	...
	*/
    public function wps_collection_single_products_list($collection, $products)
    {
        ...
        $data = [
            'products' => $products,
            'collection' => $collection,
            'show_compare_at' => $this->DB_Settings_General->get_col_value(
                'products_compare_at',
                'bool'
            ),
            'show_local' => $this->DB_Settings_General->get_col_value(
    ...
    public function wps_breadcrumbs($shortcodeData = false)
    {
        if (
            apply_filters(
                ...
                $this->DB_Settings_General->show_breadcrumbs()
            )
        ) {
            $data = [];
	...
	*/
    public function wps_product_single_thumbs_start()
    {
        ...
        return $this->Template_Loader
            ->set_template_data($data)
            ->get_template_part('components/products/single/thumbs', 'start');
    }
	...
	*/
    public function wps_product_single_thumbs_end()
    {
        ...
        return $this->Template_Loader
            ->set_template_data($data)
            ->get_template_part('components/products/single/thumbs', 'end');
    }
	...
	*/
    public function wps_cart_counter($custom_color = false)
    {
        if (!$custom_color) {
            $button_color = apply_filters(
                'wps_products_cart_counter_button_color',
                $this->DB_Settings_General->get_cart_counter_color()
            );
        } else {
        ...
        $data = [
            'button_color' =>
                $button_color !== WP_SHOPIFY_DEFAULT_CART_COUNTER_COLOR
                    ? $button_color
                    : '',
        ];
        ...
        return $this->Template_Loader
            ->set_template_data($data)
            ->get_template_part('components/cart/cart', 'counter');
    }
	...
	*/
    ...
    {
        $button_color = apply_filters(
            'wps_products_checkout_button_color',
            $this->DB_Settings_General->get_col_value(
                'checkout_color',
                'string'
            )
        );
        $button_target = apply_filters(
            'wps_cart_checkout_button_target',
            $this->DB_Settings_General->get_col_value(
                'checkout_button_target',
                'string'
            )
        );
        ...
        return $this->Template_Loader
            ->set_template_data($data)
            ->get_template_part('components/cart/cart-button', 'checkout');
    }
	...
	*/
    public function wps_cart_terms()
    {
        if (
            apply_filters(
                'wps_cart_terms_show',
                $this->DB_Settings_General->enable_cart_terms()
            )
        ) {
            $data = [
            ...
            return $this->Template_Loader
                ->set_template_data($data)
                ->get_template_part('components/cart/cart', 'terms');
        }
    }
	...
	*/
    ...
    {
        if (
            Utils::array_not_empty($cart_loaded_db_response) &&
            isset($cart_loaded_db_response[0]->cart_loaded)
        ) {
	...
	*/
    public function wps_notice()
    {
        ...
        if (
            $this->is_cart_loaded(
                $this->DB_Settings_General->get_column_single('cart_loaded')
            )
        ) {
            return $this->Template_Loader
                ->set_template_data($data)
                ->get_template_part('components/notices/not', 'found');
        }
    }
	...
	*/
    public function wps_collections_shortcode($atts)
    {
        ...
        $this->Template_Loader
            ->set_template_data($data)
            ->get_template_part('collections', 'all');
	...
	*/
    ...
    public function get_shortcode_data($data)
    {
        if (empty($data)) {
            ...
            if (
                !isset($data->shortcodeArgs) ||
                $data->shortcodeArgs['post_type'] !== 'wps_products' ||
                $data->shortcodeArgs['post_type'] !== 'wps_collections'
            ) {
                return $data;
            }

            $data->shortcodeArgs = !empty($data->shortcodeArgs)
                ? $data->shortcodeArgs
                : [];
            $data->is_shortcode =
                isset($data->is_shortcode) && $data->is_shortcode
                    ? $data->is_shortcode
                    : false;
        }
	...
	*/
    ...
    {
        $collection = $this->DB_Collections->get_collection_by_post_id(
            $post_id
        );
        ...
        if ($this->DB_Collections->has_collection($collection)) {
            $products = $this->DB_Products->get_products_by_collection_id(
			...
			*/
            foreach ($products as $key => $product) {
                $product->variants = $this->DB_Variants->get_all_variants_from_post_id(
                    $product->post_id
                );
                $product->feat_image = $this->DB_Images->get_feat_image_by_post_id(
                    $product->post_id
                );
            }
        }
	...
	*/
    ...
    public function wps_customers_account_template($template)
    {
        ...
        if ($slug && is_page($slug)) {
            if (!is_user_logged_in()) {
                $login_slug = $this->DB_Settings_General->get_col_value(
                    'account_page_login',
                    'string'
                );

                if ($login_slug) {
                    wp_safe_redirect('/' . $login_slug);
                    exit();
                } else {
                    wp_safe_redirect('/');
                    exit();
            ...
            if (!$this->DB_Customer->is_user_customer($user)) {
                $register_slug = $this->DB_Settings_General->get_col_value(
                    'account_page_register',
                    'string'
                );

                if ($register_slug) {
                    wp_safe_redirect('/' . $register_slug);
                    exit();
                } else {
                    wp_safe_redirect('/');
                    exit();
            ...
            $user_activation_key = $this->DB_Customer->get_customer_access_token_from_user_id(
                $user->data->ID
            );

            if (!empty($user_activation_key)) {
                return $this->Template_Loader->get_template_part(
                    'components/customers/account',
                    false,
                    false
                );
            }
    ...
    public function wps_customers_forgot_password_template($template)
    {
        ...
        if ($slug && is_page($slug)) {
            return $this->Template_Loader->get_template_part(
                'components/customers/forgot-password',
                false,
                false
            );
        }
    ...
    public function wps_customers_set_password_template($template)
    {
        ...
        if ($slug && is_page($slug)) {
            return $this->Template_Loader->get_template_part(
                'components/customers/set-password',
                false,
                false
            );
        }
    ...
    public function wps_customers_reset_password_by_url_template($template)
    {
        ...
        if (is_page('reset-by-url')) {
            return $this->Template_Loader->get_template_part(
                'components/customers/reset-password-by-url',
                false,
                false
            );
        }
    ...
    public function wps_page_templates($template)
    {
        ...
        $page_products_id = $this->DB_Settings_General->get_col_value(
            'page_products',
            'int'
        );
        $page_collections_id = $this->DB_Settings_General->get_col_value(
            'page_collections',
            'int'
        );
	...
	*/
    public function hooks()
    {
		...
		*/
        ...
        add_filter('page_template', [$this, 'wps_page_templates']);
		...
		*/
        ...
        add_action('wps_collections_loop_start', [
            $this,
            'wps_collections_loop_start',
        ]);
        add_action('wps_collections_loop_end', [
            $this,
            'wps_collections_loop_end',
        ]);
        add_action(
            'wps_collections_item_start',
            [$this, 'wps_collections_item_start'],
            10,
            3
        );
        add_action('wps_collections_item_end', [
            $this,
            'wps_collections_item_end',
        ]);
        add_action('wps_collections_item', [$this, 'wps_collections_item']);
        add_action('wps_collections_item_before', [
            $this,
            'wps_collections_item_before',
        ]);
        add_action('wps_collections_item_after', [
            $this,
            'wps_collections_item_after',
        ]);
        add_action('wps_collections_img', [$this, 'wps_collections_img']);
        add_action('wps_collections_title', [$this, 'wps_collections_title']);
        add_action('wps_collections_no_results', [
            $this,
            'wps_collections_no_results',
        ]);
        add_action('wps_collection_single_start', [
            $this,
            'wps_collection_single_start',
        ]);
        add_action('wps_collection_single_header', [
            $this,
            'wps_collection_single_header',
        ]);
        add_action('wps_collection_single_img', [
            $this,
            'wps_collection_single_img',
        ]);
        add_action('wps_collection_single_content', [
            $this,
            'wps_collection_single_content',
        ]);
        add_action(
            'wps_collection_single_products',
            [$this, 'wps_collection_single_products'],
            10,
            3
        );
        add_action(
            'wps_collection_single_products_list',
            [$this, 'wps_collection_single_products_list'],
            10,
            3
        );
        add_action('wps_collection_single_products_heading', [
            $this,
            'wps_collection_single_products_heading',
        ]);
        add_action('wps_collection_single_end', [
            $this,
            'wps_collection_single_end',
        ]);
        add_action('wps_collection_single_product', [
            $this,
            'wps_collection_single_product',
        ]);
        add_action(
            'wps_collection_single_heading',
            [$this, 'wps_collection_single_heading'],
            10
        );
		...
		*/
        ...
        add_action('wps_products_loop_start', [
            $this,
            'wps_products_loop_start',
        ]);
        add_action('wps_products_loop_end', [$this, 'wps_products_loop_end']);
        add_action(
            'wps_products_item_start',
            [$this, 'wps_products_item_start'],
            10,
            3
        );
        ...
        add_action(
            'wps_products_item_link_start',
            [$this, 'wps_products_item_link_start'],
            10,
            2
        );
        add_action('wps_products_item_link_end', [
            $this,
            'wps_products_item_link_end',
        ]);
        add_action('wps_products_img', [$this, 'wps_products_img']);

        add_action('wps_products_description', [
            $this,
            'wps_products_description',
        ]);

        add_action(
            'wps_products_compare_at_price',
            [$this, 'wps_products_price'],
            10,
            2
        );

        add_action('wps_products_price_wrapper_start', [
            $this,
            'wps_products_price_wrapper_start',
        ]);
        add_action('wps_products_price_wrapper_end', [
            $this,
            'wps_products_price_wrapper_end',
        ]);

        add_action('wps_products_no_results', [
            $this,
            'wps_products_no_results',
        ]);
        add_action('wps_products_add_to_cart', [
            $this,
            'wps_products_add_to_cart',
        ]);
        add_action('wps_products_meta_start', [
            $this,
            'wps_products_meta_start',
        ]);
        add_action('wps_products_quantity', [$this, 'wps_products_quantity']);
        add_action('wps_products_options', [$this, 'wps_products_options']);

        add_action('wps_products_actions_group_start', [
            $this,
            'wps_products_actions_group_start',
        ]);
        add_action('wps_products_actions_group_end', [
            $this,
            'wps_products_actions_group_end',
        ]);
        add_action('wps_products_notice_inline', [
            $this,
            'wps_products_notice_inline',
        ]);
        add_action('wps_products_meta_end', [$this, 'wps_products_meta_end']);
        add_action('wps_products_related_start', [
            $this,
            'wps_products_related_start',
        ]);
        add_action('wps_products_related_end', [
            $this,
            'wps_products_related_end',
        ]);
        add_action('wps_products_related_heading', [
            $this,
            'wps_products_related_heading',
        ]);
        add_action('wps_products_notice_out_of_stock', [
            $this,
            'wps_products_notice_out_of_stock',
        ]);
        add_action('wps_product_single_after', [$this, 'wps_related_products']);
        add_action('wps_product_single_actions_group_start', [
            $this,
            'wps_product_single_actions_group_start',
        ]);
        add_action('wps_product_single_content', [
            $this,
            'wps_product_single_content',
        ]);
        add_action('wps_product_single_header', [
            $this,
            'wps_product_single_header',
        ]);
        add_action('wps_product_single_heading', [
            $this,
            'wps_product_single_heading',
        ]);
        add_action(
            'wps_product_single_img',
            [$this, 'wps_product_single_img'],
            10,
            2
        );
        add_action('wps_product_single_imgs', [
            $this,
            'wps_product_single_imgs',
        ]);
        add_action('wps_product_single_imgs_feat_placeholder', [
            $this,
            'wps_product_single_imgs_feat_placeholder',
        ]);
        add_action(
            'wps_product_single_imgs_feat',
            [$this, 'wps_product_single_imgs_feat'],
            10,
            2
        );
        add_action('wps_product_single_info_start', [
            $this,
            'wps_product_single_info_start',
        ]);
        add_action('wps_product_single_info_end', [
            $this,
            'wps_product_single_info_end',
        ]);
        add_action('wps_product_single_gallery_start', [
            $this,
            'wps_product_single_gallery_start',
        ]);
        add_action('wps_product_single_gallery_end', [
            $this,
            'wps_product_single_gallery_end',
        ]);
        add_action('wps_product_single_start', [
            $this,
            'wps_product_single_start',
        ]);
        add_action('wps_product_single_end', [$this, 'wps_product_single_end']);
        add_action('wps_product_single_thumbs_start', [
            $this,
            'wps_product_single_thumbs_start',
        ]);
        add_action('wps_product_single_thumbs_end', [
            $this,
            'wps_product_single_thumbs_end',
        ]);
