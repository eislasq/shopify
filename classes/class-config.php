...
class Config
{
    ...
    public function __construct()
    {
        ...
        $this->placeholder_image_src =
            $this->plugin_url . 'assets/placeholder-image.png';
        // WP Shopify API
        ...
        if (!defined('WP_SHOPIFY_DEFAULT_SYNC_BY_WEBHOOKS')) {
            define(
                'WP_SHOPIFY_DEFAULT_SYNC_BY_WEBHOOKS',
                $this->plugin_default_sync_by_webhooks
            );
        }
        ...
        if (!defined('WP_SHOPIFY_SHOPIFY_HEADER_VERIFY_DOMAIN')) {
            define(
                'WP_SHOPIFY_SHOPIFY_HEADER_VERIFY_DOMAIN',
                $this->shopify_header_verify_domain
            );
        }
        ...
        if (!defined('WP_SHOPIFY_PLACEHOLDER_IMAGE_SRC')) {
            define(
                'WP_SHOPIFY_PLACEHOLDER_IMAGE_SRC',
                $this->placeholder_image_src
            );
        }
