...
class Frontend
{
	...
	*/
    ...
    public function isConnected()
    {
        ...
        if (
            empty(
                $this->plugin_settings['connection']['storefront_access_token']
            )
        ) {
            return false;
        }
    ...
    public function getMyShopifyDomain()
    {
        ...
        return $this->plugin_settings['connection']['domain'];
    }
    ...
    public function getStorefrontAccessToken()
    {
        ...
        return $this->plugin_settings['connection']['storefront_access_token'];
    }
	...
	*/
    public function public_scripts()
    {
        if (!is_admin()) {
            ...
            $this->Data_Bridge->add_settings_script('wpshopify-public');
