	...
	*/
    ...
    public function __construct()
    {
        ...
        self::$notice_allow_tracking = __(
            'Share how you\'re using WP Shopify by allowing <a href="https://docs.wpshop.io/#/guides/share-data" target="_blank">usage tracking</a> and help us make the plugin even better!<br><br> <a href="#!" class="wps-notice-link" id="wps-dismiss-tracking" style="margin-right:10px;">No thanks</a> <a id="wps-allow-tracking" data-dismiss-value="true" href="#!" class="wps-notice-link">Yes, allow usage tracking</a>',
            'wpshopify'
        );
        ...
        self::$database_migration_needed = esc_html__(
            'WP Shopify Warning: You need to migrate your database tables to the new version of WP Shopify. It\'s important that you do this before using the plugin or you will encounter errors. <a href="' .
                admin_url('admin.php?page=wps-settings&activetab=tab-misc') .
                '" class="">Click here to start the upgrade</a>.',
            'wpshopify'
        );
		...
		*/
        ...
        self::$syncing_docs_check = __(
            '<p class="wps-syncing-docs-check">🔮 Please check our documentation for <a href="https://docs.wpshop.io/#/getting-started/common-issues?id=syncing-issues" target="_blank">possible solutions to this specific error.</a></p>',
            'wpshopify'
        );
		...
		*/
        ...
        self::$missing_collections_for_page = __(
            '<b>Warning:</b> Some collections were possibly missed during the syncing process. If you notice any absent content, try clearing the plugin cache and resync.',
            'wpshopify'
        );
        ...
        self::$missing_smart_collections_for_page =
            self::$missing_collections_for_page;
        self::$missing_custom_collections_for_page =
            self::$missing_collections_for_page;
