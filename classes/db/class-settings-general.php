...
class Settings_General extends \WP_Shopify\DB
{
   ...
   */
    ...
    public function products_slug()
    {
        ...
        if (
            Utils::array_not_empty($url_products) &&
            isset($url_products[0]->url_products)
        ) {
    ...
    public function collections_slug()
    {
        ...
        if (
            Utils::array_not_empty($url_collections) &&
            isset($url_collections[0]->url_collections)
        ) {
     ...
     */
    public function products_link_to()
    {
        $products_link_to = $this->get_column_single('products_link_to');

        if (
            Utils::array_not_empty($products_link_to) &&
            isset($products_link_to[0]->products_link_to)
        ) {
            return $products_link_to[0]->products_link_to;
        } else {
            return false;
        }
    }
    ...
    public function hide_pagination()
    {
        ...
        if (
            Utils::array_not_empty($hide_pagination) &&
            isset($hide_pagination[0]->hide_pagination)
        ) {
    ...
    public function show_breadcrumbs()
    {
        ...
        if (
            Utils::array_not_empty($show_breadcrumbs) &&
            isset($show_breadcrumbs[0]->show_breadcrumbs)
        ) {
    ...
    public function enable_cart_terms()
    {
        ...
        if (
            Utils::array_not_empty($enable_cart_terms) &&
            isset($enable_cart_terms[0]->enable_cart_terms)
        ) {
    ...
    public function cart_terms_content()
    {
        ...
        if (
            Utils::array_not_empty($cart_terms_content) &&
            isset($cart_terms_content[0]->cart_terms_content)
        ) {
    ...
    public function set_free_basename($real_basename)
    {
        return $this->update_column_single(
            ['plugin_free_basename' => $real_basename],
            ['id' => 1]
        );
    }
    ...
    {
        $related_products_amount = $this->get_column_single(
            'related_products_amount'
        );

        if (
            Utils::array_not_empty($related_products_amount) &&
            isset($related_products_amount[0]->related_products_amount)
        ) {
    ...
    {
        $related_products_show = $this->get_column_single(
            'related_products_show'
        );

        if (
            Utils::array_not_empty($related_products_show) &&
            isset($related_products_show[0]->related_products_show)
        ) {
    ...
    {
        $related_products_sort = $this->get_column_single(
            'related_products_sort'
        );

        if (
            Utils::array_not_empty($related_products_sort) &&
            isset($related_products_sort[0]->related_products_sort)
        ) {
    ...
    {
        $allow_insecure_webhooks = $this->get_column_single(
            'allow_insecure_webhooks'
        );

        if (
            Utils::array_not_empty($allow_insecure_webhooks) &&
            isset($allow_insecure_webhooks[0]->allow_insecure_webhooks)
        ) {
    ...
    {
        $save_connection_only = $this->get_column_single(
            'save_connection_only'
        );

        if (
            Utils::array_not_empty($save_connection_only) &&
            isset($save_connection_only[0]->save_connection_only)
        ) {
    ...
    public function get_current_plugin_version()
    {
        ...
        if (
            Utils::array_not_empty($plugin_version) &&
            isset($plugin_version[0]->plugin_version)
        ) {
    ...
    public function get_enable_beta()
    {
        ...
        if (
            Utils::array_not_empty($enable_beta) &&
            isset($enable_beta[0]->enable_beta)
        ) {
    ...
    public function get_price_with_currency()
    {
        ...
        if (
            Utils::array_not_empty($price_with_currency) &&
            isset($price_with_currency[0]->price_with_currency)
        ) {
    ...
    public function get_add_to_cart_color()
    {
        ...
        if (
            Utils::array_not_empty($add_to_cart_color) &&
            isset($add_to_cart_color[0]->add_to_cart_color)
        ) {
    ...
    public function get_variant_color()
    {
        ...
        if (
            Utils::array_not_empty($variant_color) &&
            isset($variant_color[0]->variant_color)
        ) {
    ...
    public function get_checkout_color()
    {
        ...
        if (
            Utils::array_not_empty($checkout_color) &&
            isset($checkout_color[0]->checkout_color)
        ) {
    ...
    public function get_cart_counter_color()
    {
        ...
        if (
            Utils::array_not_empty($cart_counter_color) &&
            isset($cart_counter_color[0]->cart_counter_color)
        ) {
    ...
    public function get_cart_icon_color()
    {
        ...
        if (
            Utils::array_not_empty($cart_icon_color) &&
            isset($cart_icon_color[0]->cart_icon_color)
        ) {
    ...
    public function get_products_heading()
    {
        ...
        if (
            Utils::array_not_empty($products_heading) &&
            isset($products_heading[0]->products_heading)
        ) {
    ...
    public function get_collections_heading()
    {
        ...
        if (
            Utils::array_not_empty($collections_heading) &&
            isset($collections_heading[0]->collections_heading)
        ) {
    ...
    {
        $related_products_heading = $this->get_column_single(
            'related_products_heading'
        );

        if (
            Utils::array_not_empty($related_products_heading) &&
            isset($related_products_heading[0]->related_products_heading)
        ) {
    ...
    {
        $products_heading_toggle = $this->get_column_single(
            'products_heading_toggle'
        );

        if (
            Utils::array_not_empty($products_heading_toggle) &&
            isset($products_heading_toggle[0]->products_heading_toggle)
        ) {
    ...
    {
        $collections_heading_toggle = $this->get_column_single(
            'collections_heading_toggle'
        );

        if (
            Utils::array_not_empty($collections_heading_toggle) &&
            isset($collections_heading_toggle[0]->collections_heading_toggle)
        ) {
    ...
    {
        $related_products_heading_toggle = $this->get_column_single(
            'related_products_heading_toggle'
        );

        if (
            Utils::array_not_empty($related_products_heading_toggle) &&
            isset(
                $related_products_heading_toggle[0]
                    ->related_products_heading_toggle
            )
        ) {
            return $related_products_heading_toggle[0]
                ->related_products_heading_toggle;
        } else {
    ...
    {
        $products_images_sizing_toggle = $this->get_column_single(
            'products_images_sizing_toggle'
        );

        if (
            Utils::array_not_empty($products_images_sizing_toggle) &&
            isset(
                $products_images_sizing_toggle[0]->products_images_sizing_toggle
            )
        ) {
            return (bool) $products_images_sizing_toggle[0]
                ->products_images_sizing_toggle;
        } else {
    ...
    {
        $products_images_sizing_width = $this->get_column_single(
            'products_images_sizing_width'
        );

        if (
            Utils::array_not_empty($products_images_sizing_width) &&
            isset(
                $products_images_sizing_width[0]->products_images_sizing_width
            )
        ) {
            return (int) $products_images_sizing_width[0]
                ->products_images_sizing_width;
        } else {
    ...
    {
        $products_images_sizing_height = $this->get_column_single(
            'products_images_sizing_height'
        );

        if (
            Utils::array_not_empty($products_images_sizing_height) &&
            isset(
                $products_images_sizing_height[0]->products_images_sizing_height
            )
        ) {
            return (int) $products_images_sizing_height[0]
                ->products_images_sizing_height;
        } else {
    ...
    {
        $products_images_sizing_crop = $this->get_column_single(
            'products_images_sizing_crop'
        );

        if (
            Utils::array_not_empty($products_images_sizing_crop) &&
            isset($products_images_sizing_crop[0]->products_images_sizing_crop)
        ) {
            $saved_value =
                $products_images_sizing_crop[0]->products_images_sizing_crop;
    ...
    {
        $products_images_sizing_scale = $this->get_column_single(
            'products_images_sizing_scale'
        );

        if (
            Utils::array_not_empty($products_images_sizing_scale) &&
            isset(
                $products_images_sizing_scale[0]->products_images_sizing_scale
            )
        ) {
            $saved_value =
                $products_images_sizing_scale[0]->products_images_sizing_scale;
    ...
    {
        $collections_images_sizing_toggle = $this->get_column_single(
            'collections_images_sizing_toggle'
        );

        if (
            Utils::array_not_empty($collections_images_sizing_toggle) &&
            isset(
                $collections_images_sizing_toggle[0]
                    ->collections_images_sizing_toggle
            )
        ) {
            return (bool) $collections_images_sizing_toggle[0]
                ->collections_images_sizing_toggle;
        } else {
    ...
    {
        $collections_images_sizing_width = $this->get_column_single(
            'collections_images_sizing_width'
        );

        if (
            Utils::array_not_empty($collections_images_sizing_width) &&
            isset(
                $collections_images_sizing_width[0]
                    ->collections_images_sizing_width
            )
        ) {
            return (int) $collections_images_sizing_width[0]
                ->collections_images_sizing_width;
        } else {
    ...
    {
        $collections_images_sizing_height = $this->get_column_single(
            'collections_images_sizing_height'
        );

        if (
            Utils::array_not_empty($collections_images_sizing_height) &&
            isset(
                $collections_images_sizing_height[0]
                    ->collections_images_sizing_height
            )
        ) {
            return (int) $collections_images_sizing_height[0]
                ->collections_images_sizing_height;
        } else {
    ...
    {
        $collections_images_sizing_crop = $this->get_column_single(
            'collections_images_sizing_crop'
        );

        if (
            Utils::array_not_empty($collections_images_sizing_crop) &&
            isset(
                $collections_images_sizing_crop[0]
                    ->collections_images_sizing_crop
            )
        ) {
            $saved_value =
    ...
    {
        $collections_images_sizing_scale = $this->get_column_single(
            'collections_images_sizing_scale'
        );

        if (
            Utils::array_not_empty($collections_images_sizing_scale) &&
            isset(
                $collections_images_sizing_scale[0]
                    ->collections_images_sizing_scale
            )
        ) {
            $saved_value =
    ...
    {
        $related_products_images_sizing_toggle = $this->get_column_single(
            'related_products_images_sizing_toggle'
        );

        if (
            Utils::array_not_empty($related_products_images_sizing_toggle) &&
            isset(
                $related_products_images_sizing_toggle[0]
                    ->related_products_images_sizing_toggle
            )
        ) {
            return (bool) $related_products_images_sizing_toggle[0]
                ->related_products_images_sizing_toggle;
        } else {
    ...
    {
        $related_products_images_sizing_width = $this->get_column_single(
            'related_products_images_sizing_width'
        );

        if (
            Utils::array_not_empty($related_products_images_sizing_width) &&
            isset(
                $related_products_images_sizing_width[0]
                    ->related_products_images_sizing_width
            )
        ) {
            return (int) $related_products_images_sizing_width[0]
                ->related_products_images_sizing_width;
        } else {
    ...
    {
        $related_products_images_sizing_height = $this->get_column_single(
            'related_products_images_sizing_height'
        );

        if (
            Utils::array_not_empty($related_products_images_sizing_height) &&
            isset(
                $related_products_images_sizing_height[0]
                    ->related_products_images_sizing_height
            )
        ) {
            return (int) $related_products_images_sizing_height[0]
                ->related_products_images_sizing_height;
        } else {
    ...
    {
        $related_products_images_sizing_crop = $this->get_column_single(
            'related_products_images_sizing_crop'
        );

        if (
            Utils::array_not_empty($related_products_images_sizing_crop) &&
            isset(
                $related_products_images_sizing_crop[0]
                    ->related_products_images_sizing_crop
            )
        ) {
            $saved_value =
    ...
    {
        $related_products_images_sizing_scale = $this->get_column_single(
            'related_products_images_sizing_scale'
        );

        if (
            Utils::array_not_empty($related_products_images_sizing_scale) &&
            isset(
                $related_products_images_sizing_scale[0]
                    ->related_products_images_sizing_scale
            )
        ) {
            $saved_value =
    ...
    {
        $enable_custom_checkout_domain = $this->get_column_single(
            'enable_custom_checkout_domain'
        );

        if (
            Utils::array_not_empty($enable_custom_checkout_domain) &&
            isset(
                $enable_custom_checkout_domain[0]->enable_custom_checkout_domain
            )
        ) {
            return (bool) $enable_custom_checkout_domain[0]
                ->enable_custom_checkout_domain;
        } else {
    ...
    public function get_products_compare_at()
    {
        ...
        if (
            Utils::array_not_empty($products_compare_at) &&
            isset($products_compare_at[0]->products_compare_at)
        ) {
    ...
    {
        return $this->update_column_single(
            ['products_compare_at' => $compare_at],
            ['id' => 1]
        );
    }
    ...
    {
        return $this->update_column_single(
            ['related_products_heading' => $heading],
            ['id' => 1]
        );
    }
    ...
    {
        return $this->update_column_single(
            ['related_products_heading_toggle' => $heading],
            ['id' => 1]
        );
    }
    ...
    {
        return $this->update_column_single(
            ['products_heading_toggle' => $toggle],
            ['id' => 1]
        );
    }
    ...
    {
        return $this->update_column_single(
            ['collections_heading_toggle' => $toggle],
            ['id' => 1]
        );
    }
    ...
    {
        return $this->update_column_single(
            ['products_images_sizing_toggle' => $toggle],
            ['id' => 1]
        );
    }
    ...
    {
        return $this->update_column_single(
            ['products_images_sizing_width' => $width],
            ['id' => 1]
        );
    }
    ...
    {
        return $this->update_column_single(
            ['products_images_sizing_height' => $height],
            ['id' => 1]
        );
    }
    ...
    {
        return $this->update_column_single(
            ['products_images_sizing_crop' => $crop],
            ['id' => 1]
        );
    }
    ...
    {
        return $this->update_column_single(
            ['products_images_sizing_scale' => $scale],
            ['id' => 1]
        );
    }
    ...
    {
        return $this->update_column_single(
            ['collections_images_sizing_toggle' => $toggle],
            ['id' => 1]
        );
    }
    ...
    {
        return $this->update_column_single(
            ['collections_images_sizing_width' => $width],
            ['id' => 1]
        );
    }
    ...
    {
        return $this->update_column_single(
            ['collections_images_sizing_height' => $height],
            ['id' => 1]
        );
    }
    ...
    {
        return $this->update_column_single(
            ['collections_images_sizing_crop' => $crop],
            ['id' => 1]
        );
    }
    ...
    {
        return $this->update_column_single(
            ['collections_images_sizing_scale' => $scale],
            ['id' => 1]
        );
    }
    ...
    {
        return $this->update_column_single(
            ['related_products_images_sizing_toggle' => $toggle],
            ['id' => 1]
        );
    }
    ...
    {
        return $this->update_column_single(
            ['related_products_images_sizing_width' => $width],
            ['id' => 1]
        );
    }
    ...
    {
        return $this->update_column_single(
            ['related_products_images_sizing_height' => $height],
            ['id' => 1]
        );
    }
    ...
    {
        return $this->update_column_single(
            ['related_products_images_sizing_crop' => $crop],
            ['id' => 1]
        );
    }
    ...
    {
        return $this->update_column_single(
            ['related_products_images_sizing_scale' => $scale],
            ['id' => 1]
        );
    }
    ...
    {
        return $this->update_column_single(
            ['enable_custom_checkout_domain' => $enable],
            ['id' => 1]
        );
    }
