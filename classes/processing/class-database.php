...
class Database extends \WP_Shopify\Processing\Vendor_Background_Process
{
	...
	*/
    public function uninstall_plugin()
    {
        ...
        $results[
            'drop_custom_migration_tables'
        ] = $this->drop_custom_migration_tables(
	...
	*/
    public function drop_custom_migration_tables($table_suffix)
    {
        ...
        $results[
            'shop' . $table_suffix
        ] = $this->DB_Shop->delete_migration_table($table_suffix);
        $results[
            'settings_general' . $table_suffix
        ] = $this->DB_Settings_General->delete_migration_table($table_suffix);
        $results[
            'settings_license' . $table_suffix
        ] = $this->DB_Settings_License->delete_migration_table($table_suffix);
        $results[
            'settings_connection' . $table_suffix
        ] = $this->DB_Settings_Connection->delete_migration_table(
            $table_suffix
        );
        $results[
            'settings_syncing' . $table_suffix
        ] = $this->DB_Settings_Syncing->delete_migration_table($table_suffix);
        $results[
            'collections_smart' . $table_suffix
        ] = $this->DB_Collections_Smart->delete_migration_table($table_suffix);
        $results[
            'collections_custom' . $table_suffix
        ] = $this->DB_Collections_Custom->delete_migration_table($table_suffix);
        $results[
            'products' . $table_suffix
        ] = $this->DB_Products->delete_migration_table($table_suffix);
        $results[
            'variants' . $table_suffix
        ] = $this->DB_Variants->delete_migration_table($table_suffix);
        $results[
            'options' . $table_suffix
        ] = $this->DB_Options->delete_migration_table($table_suffix);
        $results[
            'tags' . $table_suffix
        ] = $this->DB_Tags->delete_migration_table($table_suffix);
        $results[
            'collects' . $table_suffix
        ] = $this->DB_Collects->delete_migration_table($table_suffix);
        $results[
            'images' . $table_suffix
        ] = $this->DB_Images->delete_migration_table($table_suffix);
