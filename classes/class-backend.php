...
class Backend
{
    ...
    public function admin_scripts()
    {
        if ($this->should_load_js() && !$this->is_wizard_page()) {
            ...
            $this->Data_Bridge->add_settings_script('wpshopify-admin');
        }
    }
    ...
    public function wpshopify_blocks_assets()
    {
        ...
        $this->Data_Bridge->add_settings_script('wpshopify-blocks');
    ...
    public function wpshopify_wizard_assets()
    {
        if ($this->is_wizard_page()) {
            ...
            $this->Data_Bridge->add_settings_script('wpshopify-wizard');
        }
    }
    ...
    public function wpshopify_wizard_redirect()
    {
        ...
        if (!$this->is_plugin_specific_pages() | !$gen_set) {
            return;
        }
